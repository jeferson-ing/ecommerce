...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { phone: @seller.phone, product_id: @seller.product_id, raiting: @seller.raiting, user_id: @seller.user_id } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { phone: @seller.phone, product_id: @seller.product_id, raiting: @seller.raiting, user_id: @seller.user_id } }
